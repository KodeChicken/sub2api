export default {
  ...
  usage: {
    ...
    totalCost: '总消费',
    billingRatio: '用户计费倍率',
    billingModels: '按模型计费倍率',
    billingEstimateHint: 'U 为用户实际扣费；A 为账号侧估价，并非上游实付。用户计费倍率为 U/A，预估利润为 U 减预估成本。',
    costCoefficient: '预估成本倍率',
    estimatedCost: '预估成本',
    estimatedProfit: '预估利润',
    otherModels: '其他模型',
    expandModelUsers: '展开 {model} 的用户明细',
    viewModelRecords: '查看该模型的使用记录',
    userIdFallback: '用户 #{id}',
    usersLoadFailed: '加载用户明细失败',
    loadMoreUsers: '加载更多用户',
    saveDefaultFilters: '设为默认',
    clearDefaultFilters: '清除默认',
    defaultFiltersEmpty: '请先选择查询条件',
    defaultFiltersSaved: '默认查询条件已保存（仅当前浏览器）',
    defaultFiltersCleared: '默认查询条件已清除',
    defaultFiltersSaveFailed: '保存默认查询条件失败',
    notConfigured: '未配置',
    configureCostEstimate: '配置全局预估成本',
    weeklyCostUSD: '每周预估成本',
    weeklyQuotaUSD: '每周预估可用账面额度 A',
    globalCostEstimateHint: '全局估算，不代表上游实付。修改后历史记录的预估成本也会按新系数重算。',
    clearCostEstimate: '清除配置',
    costEstimateSaved: '预估成本配置已保存',
    costEstimateLoadFailed: '加载预估成本配置失败',
    costEstimateSaveFailed: '保存预估成本配置失败',
    retry: '重试',
    unavailable: '无法计算',
    noData: '暂无数据',
    standardCost: '标准',
