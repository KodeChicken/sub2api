export default {
    ...
    groups: {
      ...
      temporaryDispatch: {
        ...
        quotaTargetExceeded: '追加用量超过当前周期剩余额度，最多可追加 {max} 个百分点',
        ...
        adjustAction: '调整临时调度',
        adjustTitle: '追加临时调度目标',
        adjustHint: '在现有目标上继续追加；当前进度不会清零。同一调度任务关联的所有分组会同步更新。',
        additionalPercent: '再追加（百分点）',
        additionalCost: '再追加用户消费金额（$）',
