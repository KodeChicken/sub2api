export default {
    ...
    subscriptions: {
      ...
      bulkResetQuota: '批量重置配额（{count}）',
      bulkResetQuotaTitle: '批量重置订阅配额',
      bulkResetQuotaAction: '重置所选配额',
      bulkResetQuotaConfirm: '确定重置选中的 {count} 个订阅的日/周/月配额吗？只修改用量配额，不会改变订阅状态和有效期。',
