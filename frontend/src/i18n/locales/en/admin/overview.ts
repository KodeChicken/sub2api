export default {
    ...
    backup: {
      ...
      imageStorage: {
        ...
        description: 'Enables asynchronous image endpoints and stores generated images on local disk or object storage, keeping only short links in Redis. Changes take effect immediately.',
        enabled: 'Enable async image tasks',
        allowLocalStorage: 'Allow local storage',
        localStorageHint: 'Generated images are stored in the server data/image-storage directory. Object storage is not required.',
    ...
    groups: {
      ...
      columns: {
        ...
        apiKeys: 'API Keys',
        accounts: 'Accounts',
        temporaryDispatch: 'Temporary dispatch',
        capacity: 'Capacity',
        usage: 'Usage',
        status: 'Status',
        actions: 'Actions',
      ...
      temporaryDispatch: {
        action: 'Temporary account',
        stopAction: 'Stop temporary dispatch',
        title: 'Temporarily switch selected groups',
        selectedGroups: '{count} groups selected',
        mode: 'Stop condition',
        modeTime: 'Time',
        modeUsage: 'Usage',
        modeHybrid: 'Usage or time',
        targetAccount: 'Target account',
        searchAccount: 'Search schedulable accounts on this platform...',
        searchMoreAccounts: 'Search for more accounts...',
        selectedAccounts: '{count}/{max} accounts selected; each account has independent stop conditions',
        clearAccounts: 'Clear',
        removeAccount: 'Remove account {account}',
        accountLimit: 'At most {max} target accounts can be selected',
        incompatibleAccountsRemoved: 'Removed {count} accounts that do not support usage-based dispatch',
        duration: 'Duration (minutes)',
        durationHint: '1–1440 minutes; the original account pool resumes on expiry',
        accountDurationHint: '1–1440 minutes; only this account leaves the temporary pool on expiry',
        quotaWindow: 'Quota window (choose one)',
        quotaTargetInput: 'Target usage (%)',
        costWindow: 'Spend tracking window (choose one)',
        targetCost: 'Target user spend ($)',
        targetCostHint: 'Tracks final user charges from these dispatch groups only when requests are served by this account, including group and user multipliers.',
        quotaLoading: 'Loading the latest account quota…',
        quotaCurrent: 'Current',
        quotaTarget: 'Target',
        quotaReset: 'Reset',
        quotaUnavailable: 'The account has no valid {window} quota window',
        quotaLoadFailed: 'Failed to load account quota',
        quotaTargetInvalid: 'Target usage must be greater than the current {current}% and no more than 100%',
        sharedQuotaHint: 'The account remains shared; quota usage from other traffic also advances this target.',
        userSpendHint: 'Only user spend from these dispatch groups that is actually served by this target account is counted.',
        noAccounts: 'No matching schedulable accounts',
        active: 'Account #{account}',
        activePool: 'Temporary pool: {count} accounts',
        expiresAt: 'Expires: {time}',
        start: 'Start takeover',
        started: 'Temporary dispatch started',
        stopped: 'Temporary dispatch stopped; original account pools restored',
        adjustAction: 'Adjust dispatch',
        adjustTitle: 'Set temporary dispatch targets',
        adjustHint: 'Sets the new final target directly without resetting progress. All groups belonging to this dispatch are updated together.',
        targetPercent: 'Target usage (%)',
        targetSpend: 'Target user spend ($)',
        targetReachedHint: 'Current progress has already reached this target. Saving will immediately remove this account from the temporary pool.',
        extendDuration: 'Extend duration (minutes)',
        currentProgress: 'Current {current} / target {target}',
        adjusted: 'Temporary dispatch targets updated',
        adjustSubmit: 'Save targets',
        selectGroups: 'Select one or more groups first',
        samePlatform: 'Only groups on the same platform can be selected together',
        compositeUnsupported: 'Composite groups cannot be temporarily routed to one account',
        selectAccount: 'Select a target account',
        failed: 'Temporary dispatch operation failed'
      },
      claudeMaxSimulation: {
