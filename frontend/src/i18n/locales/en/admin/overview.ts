export default {
    ...
    groups: {
      ...
      temporaryDispatch: {
        ...
        quotaDelta: 'Additional usage (percentage points)',
        costWindow: 'Spend tracking window (choose one)',
        targetCost: 'Additional user spend ($)',
        ...
        quotaTargetExceeded: 'Additional usage exceeds this window; at most {max} percentage points remain',
        ...
        adjustTitle: 'Extend temporary dispatch targets',
        adjustHint: 'Adds to the existing targets without resetting progress. All groups belonging to this dispatch are updated together.',
        additionalPercent: 'Add percentage points',
        additionalCost: 'Add user spend ($)',
