export default {
    ...
    groups: {
      ...
      temporaryDispatch: {
        ...
        costWindow: 'Cost accounting window (choose one)',
        targetCost: 'Additional account cost ($)',
        targetCostHint: 'Calculated with the {rate}x account multiplier; under the current 1:1 rule, $1 corresponds to ¥1.',
        ...
        sharedQuotaHint: 'The account remains shared; usage from other traffic also advances this target.',
        ...
        additionalCost: 'Add account cost ($)',
