export default {
    ...
    subscriptions: {
      ...
      bulkResetQuota: 'Reset quota ({count})',
      bulkResetQuotaTitle: 'Bulk reset subscription quotas',
      bulkResetQuotaAction: 'Reset selected quotas',
      bulkResetQuotaConfirm: 'Reset daily, weekly, and monthly quotas for the {count} selected subscriptions? This changes quota usage only; subscription status and expiry remain unchanged.',
      bulkQuotaResetSuccess: 'Quota reset for {count} subscriptions',
