export default {
    accounts: {
      ...
      monthlyCostPlaceholder: 'Not configured',
      monthlyCostHint: 'Optional; used for the cost coefficient in usage records. Leave blank to unset.',
      monthlyCostInvalid: 'Monthly cost must be a positive amount',
      ...
      openaiQuotaReset: {
        ...
        reset: 'Reset',
        carpoolReset: 'Reset carpool subscriptions',
        carpoolResetTitle: 'Reset carpool subscription quotas',
        carpoolResetConfirm: 'Reset the configured daily, weekly, and monthly quotas for {count} active subscriptions bound through this account? Subscription status and expiry will not change.',
        carpoolResetSuccess: 'Reset quotas for {count} carpool subscriptions',
        carpoolResetFailed: 'The account reset succeeded, but carpool subscription quotas could not be reset. Use the fallback action and review the audit log.',
        carpoolResetTooltip: 'Manually reset active subscription quotas in enabled carpool groups bound to this account',
        carpoolNoSubscriptions: 'No active carpool subscriptions with configured quotas are bound to this account',
        carpoolUndo: 'Undo last reset',
        carpoolUndoTitle: 'Undo the latest carpool quota reset',
        carpoolUndoConfirm: 'Restore the quota snapshot from before the latest reset. Usage accrued after that reset will be retained. If another quota reset has since occurred, the operation will be refused.',
        carpoolUndoSuccess: 'Restored quotas for {count} subscriptions; usage accrued since reset was retained',
