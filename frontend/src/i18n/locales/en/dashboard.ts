export default {
  ...
  usage: {
    ...
    billingRatio: 'User billing ratio',
    billingModels: 'Billing ratio by model',
    billingEstimateHint: 'U is charged to users; A is an account-side estimate, not the amount paid upstream. User billing ratio = U/A; estimated profit = U minus estimated cost.',
    costCoefficient: 'Estimated cost factor',
    estimatedCost: 'Est. cost',
    estimatedProfit: 'Est. profit',
    otherModels: 'Other models',
    expandModelUsers: 'Expand users for {model}',
    viewModelRecords: 'View usage records for this model',
    userIdFallback: 'User #{id}',
    usersLoadFailed: 'Failed to load user details',
    loadMoreUsers: 'Load more users',
    saveDefaultFilters: 'Set as default',
    clearDefaultFilters: 'Clear default',
    defaultFiltersEmpty: 'Select a filter first',
    defaultFiltersSaved: 'Default filters saved in this browser',
    defaultFiltersCleared: 'Default filters cleared',
    defaultFiltersSaveFailed: 'Failed to save default filters',
    notConfigured: 'Not configured',
    configureCostEstimate: 'Configure global cost estimate',
    weeklyCostUSD: 'Estimated weekly cost',
    weeklyQuotaUSD: 'Estimated weekly book-value capacity A',
    globalCostEstimateHint: 'A global estimate, not the amount paid upstream. Changing it recalculates historical estimates.',
    clearCostEstimate: 'Clear configuration',
    costEstimateSaved: 'Cost estimate saved',
    costEstimateLoadFailed: 'Failed to load cost estimate',
    costEstimateSaveFailed: 'Failed to save cost estimate',
    retry: 'Retry',
