...
const (
	...
	// FieldIsCarpool holds the string denoting the is_carpool field in the database.
	FieldIsCarpool = "is_carpool"
...
var (
	...
	// DefaultIsCarpool holds the default value on creation for the "is_carpool" field.
	DefaultIsCarpool bool
...
// ByIsCarpool orders the results by the is_carpool field.
func ByIsCarpool(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldIsCarpool, opts...).ToFunc()
}
