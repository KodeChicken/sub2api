...
func init() {
	...
	// groupDescIsCarpool is the schema descriptor for is_carpool field.
	groupDescIsCarpool := groupFields[8].Descriptor()
	// group.DefaultIsCarpool holds the default value on creation for the is_carpool field.
	group.DefaultIsCarpool = groupDescIsCarpool.Default.(bool)
	...
	// usersubscriptionDescQuotaResetRevision is the schema descriptor for quota_reset_revision field.
	usersubscriptionDescQuotaResetRevision := usersubscriptionFields[11].Descriptor()
	// usersubscription.DefaultQuotaResetRevision holds the default value on creation for the quota_reset_revision field.
	usersubscription.DefaultQuotaResetRevision = usersubscriptionDescQuotaResetRevision.Default.(int64)
