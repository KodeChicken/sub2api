...
const (
	...
	// FieldQuotaResetRevision holds the string denoting the quota_reset_revision field in the database.
	FieldQuotaResetRevision = "quota_reset_revision"
...
var (
	...
	// DefaultQuotaResetRevision holds the default value on creation for the "quota_reset_revision" field.
	DefaultQuotaResetRevision int64
...
// ByQuotaResetRevision orders the results by the quota_reset_revision field.
func ByQuotaResetRevision(opts ...sql.OrderTermOption) OrderOption {
	return sql.OrderByField(FieldQuotaResetRevision, opts...).ToFunc()
}
