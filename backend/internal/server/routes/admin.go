...
func registerSettingsRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	adminSettings := admin.Group("/settings")
	{
		...
		adminSettings.GET("/usage-cost-estimate", h.Admin.Setting.GetUsageCostEstimate)
		adminSettings.PUT("/usage-cost-estimate", h.Admin.Setting.UpdateUsageCostEstimate)
...
func registerUsageRoutes(admin *gin.RouterGroup, h *handler.Handlers) {
	usage := admin.Group("/usage")
	{
		...
		usage.GET("/billing-analysis", h.Admin.Usage.BillingAnalysis)
		usage.GET("/billing-analysis/users", h.Admin.Usage.BillingAnalysisUsers)
