...
type UserSubscriptionRepository interface {
	...
	List(ctx context.Context, params pagination.PaginationParams, userID, groupID *int64, status, platform, sortBy, sortOrder, groupName string) ([]UserSubscription, *pagination.PaginationResult, error)
