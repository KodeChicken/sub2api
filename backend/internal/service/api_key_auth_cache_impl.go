...
const apiKeyAuthSnapshotVersion = 25 // v25: temporary dispatch account pools and per-account deadlines
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	if apiKey.Group != nil {
		snapshot.Group = &APIKeyAuthGroupSnapshot{
			...
			TemporaryDispatchAccountID:        apiKey.Group.TemporaryDispatchAccountID,
			TemporaryDispatchAccountIDs:       append([]int64(nil), apiKey.Group.TemporaryDispatchAccountIDs...),
			TemporaryDispatchAccountDeadlines: cloneTimeMap(apiKey.Group.TemporaryDispatchAccountDeadlines),
			TemporaryDispatchID:               apiKey.Group.TemporaryDispatchID,
			TemporaryDispatchStartedAt:        apiKey.Group.TemporaryDispatchStartedAt,
			TemporaryDispatchExpiresAt:        apiKey.Group.TemporaryDispatchExpiresAt,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	if snapshot.Group != nil {
		apiKey.Group = &Group{
			...
			TemporaryDispatchAccountID:        snapshot.Group.TemporaryDispatchAccountID,
			TemporaryDispatchAccountIDs:       append([]int64(nil), snapshot.Group.TemporaryDispatchAccountIDs...),
			TemporaryDispatchAccountDeadlines: cloneTimeMap(snapshot.Group.TemporaryDispatchAccountDeadlines),
			TemporaryDispatchID:               snapshot.Group.TemporaryDispatchID,
			TemporaryDispatchStartedAt:        snapshot.Group.TemporaryDispatchStartedAt,
			TemporaryDispatchExpiresAt:        snapshot.Group.TemporaryDispatchExpiresAt,
